...
// Also excludes repos promoted to full showcase cards below
const EXCLUDED_REPOS = ['portfolio', 'news-image-classification', 'SmartHR', 'Stock-Price-Prediction'];
...
const LOCAL_PROJECTS = [
  ...
  {
    name: 'News & Image Classification',
    url: 'https://github.com/iprateekyadav1/news-image-classification',
    desc: 'B.Tech final-year DL project combining CNN (CIFAR-10), BiLSTM, and DistilBERT (AG News) with an interactive Cyberpunk HUD Flask web demo',
    tags: ['Python', 'CNN', 'BiLSTM', 'DistilBERT', 'Flask', 'Deep Learning'],
    category: 'deep-learning',
    icon: '🧠',
    github: true
  },
  {
    name: 'SmartHR — AI HR Management',
    url: 'https://github.com/iprateekyadav1/SmartHR',
    desc: 'B.Tech CS Final Year Project — AI-powered HR Management with NLP resume parsing, 3D animated UI, payroll engine, and live analytics dashboard',
    tags: ['HTML', 'NLP', '3D UI', 'Payroll Engine', 'Analytics'],
    category: 'github',
    icon: '🏢',
    github: true
  },
  {
    ...
    url: 'https://github.com/iprateekyadav1/Stock-Price-Prediction',
    desc: 'LSTM-based deep learning system predicting future stock prices from historical market data with time-series preprocessing and visualization',
    tags: ['Python', 'LSTM', 'Time Series', 'Deep Learning', 'Matplotlib'],
    category: 'deep-learning',
    icon: '📈',
    github: true
  },
...
function renderLocalProjects() {
  ...
  LOCAL_PROJECTS.forEach((project) => {
    ...
    // All template data comes from the hardcoded LOCAL_PROJECTS array above — not user input.
    const iconHTML = project.icon
      ? `<div class="kc-card__icon" style="font-size:1.5rem;line-height:1">${project.icon}</div>`
      : `<div class="kc-card__icon"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div>`;

    const ctaHTML = project.github
      ? `<div class="kc-card__cta">View on GitHub <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></div>`
      : `<div class="kc-card__cta">View Details <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></div>`;
